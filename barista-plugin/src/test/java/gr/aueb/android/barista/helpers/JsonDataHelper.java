...
public class JsonDataHelper {
    ...
    public static final String WM_SIZE_JSON = "{\"type\":\"WmSize\",\"sessionToken\":\""+ConstantValues.sessionToken+"\",\"width\":"+ConstantValues.width+",\"height\":"+ConstantValues.height+",\"reset\":false,\"unit\":\"DPI\"}";
    ...
    public static final String DENSITY_JSON = "{\"type\":\"WmDensity\",\"sessionToken\":\"3\",\"density\":"+ConstantValues.density+"}";
    ...
    public static final String REVOKE_JSON = "{\"type\":\"PmRevoke\",\"sessionToken\":\""+ConstantValues.sessionToken+"\",\"permission\":\""+ConstantValues.permission+"\"}";
