...
public class BaristaCommandPrefixes {
    ...
    public static final String DUMPSYS_BATTERY_LEVEL = "shell dumpsys battery set ac "; // 0 |1
    public static final String DUMPSYS_CHARGE_STATUS = "shell dumpsys battery set level "; // 0 - 100
